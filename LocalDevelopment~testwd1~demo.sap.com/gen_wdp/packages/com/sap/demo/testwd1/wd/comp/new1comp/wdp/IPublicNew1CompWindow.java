...
public interface IPublicNew1CompWindow {
  ...
  {
    private static final long serialVersionUID = 0xef7cc2cc33433ef7L;
    
    private InternalNew1CompWindow gen_delegate;

    IContextNode(InternalNew1CompWindow delegate, IGCINodeInfo nodeInfo, Node parent) {
    ...
    protected com.sap.tc.webdynpro.progmodel.context.Node createNode(IGCINodeInfo nodeInfo, com.sap.tc.webdynpro.progmodel.context.Node parentNode, com.sap.tc.webdynpro.progmodel.context.NodeElement parentElement) {
      if (nodeInfo == gen_delegate.infoContext)
        return new IPrivateNew1CompWindow.IContextNode(gen_delegate, nodeInfo, parentNode);
    ...
    protected com.sap.tc.webdynpro.progmodel.context.NodeElement doCreateElement(IGCINodeInfo nodeInfo, Object reference) {
      if (nodeInfo == gen_delegate.infoContext) {
        return new IPrivateNew1CompWindow.IContextElement(gen_delegate, nodeInfo);
      }
     ...
     */
    public IPrivateNew1CompWindow.IContextElement createContextElement() {
      return (IPrivateNew1CompWindow.IContextElement)createElement();
    }
     ...
     * @return an element for this node
     */
    public IPrivateNew1CompWindow.IContextElement createAndAddContextElement() {
      return (IPrivateNew1CompWindow.IContextElement)createAndAddElement();
    }
     ...
     */
    public void bind(IPrivateNew1CompWindow.IContextElement element) {
     ...
     */
    public IPrivateNew1CompWindow.IContextElement currentContextElement() {
      return (IPrivateNew1CompWindow.IContextElement) getCurrentElement();
    }
  ...
  {
    private static final long serialVersionUID = 0x866d5df24fbab661L;
    
    private InternalNew1CompWindow gen_delegate;

    IContextElement(InternalNew1CompWindow delegate, com.sap.tc.webdynpro.progmodel.gci.IGCINodeInfo info) {
      super(info);
      gen_delegate = delegate;
    }
