...
// $JL-GENERATED-SOURCE$
// ---------------------------------------------------------------------------
package com.sap.demo.testwd1.wd.comp.new1comp.wdp;
...
public interface IPrivateNew1CompView {
  ...
  {
    private static final long serialVersionUID = 0xbc2a4bb7edd2543dL;
    
    private InternalNew1CompView gen_delegate;

    IContextNode(InternalNew1CompView delegate, IGCINodeInfo nodeInfo, Node parent) {
    ...
    protected com.sap.tc.webdynpro.progmodel.context.Node createNode(IGCINodeInfo nodeInfo, com.sap.tc.webdynpro.progmodel.context.Node parentNode, com.sap.tc.webdynpro.progmodel.context.NodeElement parentElement) {
      if (nodeInfo == gen_delegate.infoContext)
        return new IPrivateNew1CompView.IContextNode(gen_delegate, nodeInfo, parentNode);
    ...
    protected com.sap.tc.webdynpro.progmodel.context.NodeElement doCreateElement(IGCINodeInfo nodeInfo, Object reference) {
      if (nodeInfo == gen_delegate.infoContext) {
        return new IPrivateNew1CompView.IContextElement(gen_delegate, nodeInfo);
      }
     ...
     */
    public IPrivateNew1CompView.IContextElement createContextElement() {
      return (IPrivateNew1CompView.IContextElement)createElement();
    }
     ...
     * @return an element for this node
     */
    public IPrivateNew1CompView.IContextElement createAndAddContextElement() {
      return (IPrivateNew1CompView.IContextElement)createAndAddElement();
    }
     ...
     */
    public void bind(IPrivateNew1CompView.IContextElement element) {
     ...
     */
    public IPrivateNew1CompView.IContextElement currentContextElement() {
      return (IPrivateNew1CompView.IContextElement) getCurrentElement();
    }
  ...
  {
    private static final long serialVersionUID = 0x1cdda927e495bb38L;
    
    private InternalNew1CompView gen_delegate;

    IContextElement(InternalNew1CompView delegate, com.sap.tc.webdynpro.progmodel.gci.IGCINodeInfo info) {
      super(info);
      gen_delegate = delegate;
    }
  ...
  {
    private static final long serialVersionUID = 0xfb7a1ccbd3385edfL;
